...
class WidgetForm extends CWidgetForm {
	...
	private function initDisplayingOptionsFields(): self {
		return $this
			...
			->addField(
				(new CWidgetFieldRadioButtonList('hintbox_sort', _('Hintbox sorting option'), [
					0 => _x('Name', 'default hintbox sort select'),
					1 => _('Value (asc)'),
					2 => _('Value (desc)')
				]))->setDefault(0)
			)
			...
			->addField(
				new CWidgetFieldCheckBox('suppress_zero_values', _('Suppress Zero Values'))
			);
	}
